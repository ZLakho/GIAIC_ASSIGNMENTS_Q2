const Header = () => {
  return (
    <div>
      <header className='flex bg-white border-b py-3 sm:px-6 px-4 font-[sans-serif] min-h-[75px] tracking-wide relative z-50 justify-center items-center'>
        <div className='flex max-w-screen-xl mx-auto w-full'>
          <div className='flex flex-wrap items-center lg:gap-y-2 gap-4 w-full'>
            <h1 className="flex justify-center items-center text-black text-4xl h-10">cyber</h1>
            ...
            <div id="collapseMenu"
              ...
              <ul
                ...
                <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                  className='text-gray-900 hover:text-[#007bff] text-[15px] block font-semibold'>Home</a></li>
                <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                  className='text-gray-600 hover:text-[#007bff] text-[15px] block font-semibold'>About</a></li>
                <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                  className='text-gray-600 hover:text-[#007bff] text-[15px] block font-semibold'>Contact Us</a></li>
                <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                  className='text-gray-600 hover:text-[#007bff] text-[15px] block font-semibold'>Blog</a></li>
              </ul>
            </div>
